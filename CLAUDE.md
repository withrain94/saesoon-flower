...
| 예약 저장 (Supabase) | ✅ 운영 중. **DB 예약 4건 — 전부 취소 상태, 실제 손님 예약 0건**(21:05 확인): 9AF9D2A5(Claude PDF 시험, 메모 있음) · 0213E2AE(사용자 "래인2" 카톡 시험, 메모 있음) · E4A75539·7E13BBEE(사장님 시험 예약, 사용자 확인 후 메모 추가). 예전 시험 예약들은 사용자 요청으로 삭제했었음 |
